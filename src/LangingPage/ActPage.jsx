...
function Activities() {
  ...
  // 3. Navigation handler with dynamic batch parameter
  const handleViewDetail = (batch) => {
    // Encodes the batch (e.g., "2024-25") for the URL
  ...
  return (
    <>
      ...
      <div 
        ref={sectionRef}
        id="activities" 
        className="h-screen bg-[#F5F9FA] flex flex-col font-sans py-12 perspective-[1000px] select-none"
      >
        {/* Header */}
                ...
                activitiesData.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="md:col-span-4 flex flex-col md:items-center">
                      ...
                      <span className="text-sm font-semibold text-[#3C3E40] group-hover/row:text-[#023347] transition-colors">
                        {item.batch}
                      </span>
                    </div>
